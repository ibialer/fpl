      ...
      1: {
        ...
        totalPoints: 55, players: [
          { name: 'Defender', points: 6, position: 1, isBenched: false, positionName: 'DEF',
            ...
            perGameStats: [{ fixtureId: 1, opponentShortName: 'CHE', isHome: true, minutes: 90, goals: 0, assists: 0, cleanSheet: true, yellowCards: 0, redCards: 0, bonus: 0, saves: 0, penaltiesSaved: 0, penaltiesMissed: 0, ownGoals: 0, defensiveContribution: 5, points: 6 }] },
          { name: 'Midfielder', points: 8, position: 2, isBenched: false, positionName: 'MID',
            ...
            perGameStats: [{ fixtureId: 1, opponentShortName: 'CHE', isHome: true, minutes: 74, goals: 1, assists: 0, cleanSheet: false, yellowCards: 0, redCards: 0, bonus: 0, saves: 0, penaltiesSaved: 0, penaltiesMissed: 0, ownGoals: 0, defensiveContribution: 3, points: 8 }] },
          { name: 'Forward', points: 10, position: 3, isBenched: false, positionName: 'FWD',
            ...
            perGameStats: [{ fixtureId: 1, opponentShortName: 'CHE', isHome: true, minutes: 90, goals: 2, assists: 0, cleanSheet: false, yellowCards: 0, redCards: 0, bonus: 0, saves: 0, penaltiesSaved: 0, penaltiesMissed: 0, ownGoals: 0, defensiveContribution: 2, points: 10 }] },
        ],
      },
      2: {
        entryId: 2, teamName: 'Away Team', playerName: 'Manager B',
